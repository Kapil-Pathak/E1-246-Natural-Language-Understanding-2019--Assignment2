...
corpus=open('/home/kapil/Multiplicative/deu.txt', 'r').readlines()
...
MODEL_SAVE_PATH="/home/kapil/Multiplicative/encoder.pt"
#torch.save(decoder.state_dict(), MODEL_SAVE_PATH)
torch.save(encoder.state_dict(), MODEL_SAVE_PATH)
MODEL_SAVE_PATH1="/home/kapil/Multiplicative/decoder.pt"
#torch.save(decoder.state_dict(), MODEL_SAVE_PATH)

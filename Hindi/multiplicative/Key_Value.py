...
corpus=open('/home/kapil/Hindi_Translation/multiplicative/eng_hindi.txt', 'r').readlines()
corpus=corpus[:10000]
print(len(corpus))
...
MODEL_SAVE_PATH="/home/kapil/Hindi_Translation/multiplicative/encoder.pt"
#torch.save(decoder.state_dict(), MODEL_SAVE_PATH)
torch.save(encoder.state_dict(), MODEL_SAVE_PATH)
MODEL_SAVE_PATH1="/home/kapil/Hindi_Translation/multiplicative/decoder.pt"
#torch.save(decoder.state_dict(), MODEL_SAVE_PATH)
